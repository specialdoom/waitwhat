...
void _todoSerialize(
  ...
  writer.writeLong(offsets[5], object.sourceMessageId);
...
Todo _todoDeserialize(
  ...
  object.priority =
      _TodopriorityValueEnumMap[reader.readByteOrNull(offsets[4])] ??
          Priority.low;
  object.sourceMessageId = reader.readLongOrNull(offsets[5]);
...
extension TodoQueryFilter on QueryBuilder<Todo, Todo, QFilterCondition> {
  ...
  QueryBuilder<Todo, Todo, QAfterFilterCondition> sourceMessageIdIsNull() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(const FilterCondition.isNull(
  ...
  QueryBuilder<Todo, Todo, QAfterFilterCondition> sourceMessageIdIsNotNull() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(const FilterCondition.isNotNull(
        property: r'sourceMessageId',
      ));
  ...
  QueryBuilder<Todo, Todo, QAfterFilterCondition> sourceMessageIdEqualTo(
      int? value) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'sourceMessageId',
  ...
  QueryBuilder<Todo, Todo, QAfterFilterCondition> sourceMessageIdGreaterThan(
    int? value, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Todo, Todo, QAfterFilterCondition> sourceMessageIdLessThan(
    int? value, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Todo, Todo, QAfterFilterCondition> sourceMessageIdBetween(
    int? lower,
    int? upper, {
    bool includeLower = true,
    bool includeUpper = true,
...
extension TodoQuerySortBy on QueryBuilder<Todo, Todo, QSortBy> {
  ...
  QueryBuilder<Todo, Todo, QAfterSortBy> sortBySourceMessageId() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'sourceMessageId', Sort.asc);
    });
  }

  QueryBuilder<Todo, Todo, QAfterSortBy> sortBySourceMessageIdDesc() {
    return QueryBuilder.apply(this, (query) {
...
extension TodoQuerySortThenBy on QueryBuilder<Todo, Todo, QSortThenBy> {
  ...
  QueryBuilder<Todo, Todo, QAfterSortBy> thenBySourceMessageId() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'sourceMessageId', Sort.asc);
    });
  }

  QueryBuilder<Todo, Todo, QAfterSortBy> thenBySourceMessageIdDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'sourceMessageId', Sort.desc);
    });
  }
...
extension TodoQueryWhereDistinct on QueryBuilder<Todo, Todo, QDistinct> {
  ...
  QueryBuilder<Todo, Todo, QDistinct> distinctBySourceMessageId() {
    return QueryBuilder.apply(this, (query) {
...
extension TodoQueryProperty on QueryBuilder<Todo, Todo, QQueryProperty> {
  ...
  QueryBuilder<Todo, int?, QQueryOperations> sourceMessageIdProperty() {
    return QueryBuilder.apply(this, (query) {
